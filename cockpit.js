...
function render(){
  ...
  html+=`<div class="mono" style="padding:8px 0 24px">sample data · figures in inr · one visualization per card · pin order: newest last · <a class="xlink" href="explore.html">on-demand explorer →</a></div>`;
